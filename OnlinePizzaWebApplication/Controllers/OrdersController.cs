...
namespace OnlinePizzaWebApplication.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(Order order)
        {
            ...
            {
                ModelState.AddModelError("", "Twój koszyk jest pusty, najpierw dodaj pizze");
            }
        ...
        {
            ViewBag.CheckoutCompleteMessage = $"Dziêkujemy za zamówienie, wkrótce dostarczymy pizze!";
            return View();
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            if (isAdmin == false)
            {
                ...
                {
                    return BadRequest("Nie masz uprawnieñ, aby wyœwietliæ to zamówienie.");
                }
            }
